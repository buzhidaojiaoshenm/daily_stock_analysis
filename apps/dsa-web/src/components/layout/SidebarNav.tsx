...
import { BarChart3, BriefcaseBusiness, Home, LineChart, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'market-review', label: '复盘', to: '/market-review', icon: LineChart },
