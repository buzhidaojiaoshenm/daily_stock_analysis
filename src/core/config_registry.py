...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SCHEDULE_TIME": {
        "title": "Schedule Time",
        "description": "Daily schedule time in HH:MM format, interpreted in SCHEDULE_TIMEZONE.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "SCHEDULE_TIMEZONE": {
        ...
        "description": "IANA timezone used by the built-in scheduler, for example Asia/Shanghai or America/New_York.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "HTTP_PROXY": {
        "title": "HTTP Proxy",
        "description": "Optional proxy endpoint for HTTP requests. Prefer this direct proxy variable; USE_PROXY/PROXY_HOST/PROXY_PORT are kept as a local shortcut.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "default_value": None,
        "options": [],
        "validation": {"item_type": "url", "allowed_schemes": ["http", "https", "socks5", "socks5h"]},
        "display_order": 20,
    },
    "HTTPS_PROXY": {
        "title": "HTTPS Proxy",
        "description": "Optional proxy endpoint for HTTPS requests. Use the same value as HTTP_PROXY when one proxy handles both protocols.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "NO_PROXY": {
        "title": "No Proxy",
        "description": "Comma-separated hosts or domains that should bypass the proxy.",
        "category": "system",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "USE_PROXY": {
        "title": "Use Local Proxy Shortcut",
        "description": "Legacy local shortcut that builds http://PROXY_HOST:PROXY_PORT when true. GitHub Actions skips this shortcut.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PROXY_HOST": {
        "title": "Proxy Host",
        "description": "Host used by the legacy USE_PROXY shortcut.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PROXY_PORT": {
        "title": "Proxy Port",
        "description": "Port used by the legacy USE_PROXY shortcut.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ANALYSIS_TASK_QUEUE_LIMIT": {
        "title": "Analysis Task Queue Limit",
        "description": "Maximum pending/processing async analysis tasks. Set 0 to disable the queue capacity guard.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ANALYSIS_TASK_TIMEOUT_SECONDS": {
        ...
        "description": "Seconds before pending/processing async tasks are marked timeout. Set 0 to disable timeout marking.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ANALYSIS_TASK_MAX_RETRIES": {
        "title": "Analysis Task Max Retries",
        "description": "Additional retry attempts for async analysis tasks after a classified failure.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
