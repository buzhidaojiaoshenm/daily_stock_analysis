...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "strategy_basis_heading": "策略依据",
        "active_skills_label": "启用策略",
        "matched_skills_label": "主要命中",
        "rejected_skills_label": "暂未命中",
        "strategy_rationale_label": "判断摘要",
    ...
    "en": {
        ...
        "strategy_basis_heading": "Strategy Basis",
        "active_skills_label": "Active Skills",
        "matched_skills_label": "Matched Skills",
        "rejected_skills_label": "Not Matched",
        "strategy_rationale_label": "Rationale",
